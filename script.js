...
function showCareerDetails(careerName) {
    ...
    <div class="resource-card bg-gray-50 p-4 rounded-lg hover:bg-gray-100">
        <div class="flex justify-between items-start">
            ...
            <div class="flex items-center gap-2">
                ...
                <button onclick="window.open('${resource.link}', '_blank')" class="text-blue-600 underline text-xs">Open</button>
            </div>
        </div>
    </div>
`).join('')}
